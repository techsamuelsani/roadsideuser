...
public class ServiceCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final ServiceCategoryItemClickListener listener;
    SettingsModel settingsModel;


    public ServiceCategoryAdapter(Context context, ServiceCategoryModel serviceModel, boolean isProviderInfo, ServiceCategoryItemClickListener listener) {
...
//            view.serviceDetails.setText(serviceModel.getData().get(position).getDetails());
            ...
            view.serviceName.setText(serviceModel.getCategory().get(position).getName());
            view.serviceDetails.setText(serviceModel.getCategory().get(position).getDescription());
            view.servicePrice.setText(ctx.getResources().getString(R.string.starting_from)+settingsModel.getData().getAppCurrency()+" "+serviceModel.getCategory().get(position).getBasePrice());
            ...
            view.lytService.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    listener.onItemClick(serviceModel.getCategory().get(position).getSubcategories(),serviceModel.getCategory().get(position));
                }
            });

            // String imageUrl=Config.IMAGE_URL+"services/"+serviceModel.getCategory().get(position).getImage();
            String imageUrl=serviceModel.getCategory().get(position).getImage();
    ...
    public int getItemCount() {
        return serviceModel.getCategory().size();
    }
