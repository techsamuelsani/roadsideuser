...
public class SubCategoryFragment extends Fragment {
    ...
    private ServiceSubCategoryAdapter serviceSubCategoryAdapter;

    public SubCategoryFragment(ServiceSubCategoryAdapter serviceSubCategoryAdapter) {
       this.serviceSubCategoryAdapter=serviceSubCategoryAdapter;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView subcatRecycler=view.findViewById(R.id.subcat_recycler);
        subcatRecycler.setLayoutManager(new LinearLayoutManager(getContext()));
        subcatRecycler.setAdapter(serviceSubCategoryAdapter);
